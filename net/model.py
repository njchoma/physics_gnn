...
from net.architectures.complex import RGCs_FCL
from net.architectures.dummy import Dummy, DummyGconv
from net.architectures.netarch import GNN, GNNSpatial
from net.architectures.modifnetarch import GNNModif, GNNModifSpatial
from net.architectures.resnetarch import GNNRes, GNNResSpatial

from net.batchgen.getbatch import GetBatch
from net.statistics import Statistics
from graphic.roccurve import ROCCurve
from net.batchgen.weightfunc import getweightfunc
...
def init_model_type(param):
    ...
    # GNNs
        ...
        return GNNSpatial(param.dim, param.deg, logistic_bias=param.logistic_bias), \
            ['dim', 'deg', 'logistic_bias']
    ...
    # RESIDUAL GNNs
        ...
        return GNNResSpatial(param.dim, param.deg, usebatchnorm=param.batchnorm,
                             logistic_bias=param.logistic_bias), \
            ['dim', 'deg', 'batchnorm', 'logistic_bias']
    ...
    # MORE COMPLEX MODELS
        ...
        return RGCs_FCL(param.dim, param.deg, usebatchnorm=param.batchnorm,
                        logistic_bias=param.logistic_bias), \
            ['dim', 'deg', 'batchnorm', 'logistic_bias']
...
class Model:
    ...
    def do_one_batch(self, batchgen, mode, criterion=None, optimizer=None, roccurve=None):
        ...
        # update stats
        kernel_std = self.net.adjacency.std.abs().data[0]
        if criterion is not None:
